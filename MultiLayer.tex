...
In that way, each dataset obtained from diagonalizing a $N\times N$ matrix is labelled by the coupling constant $g_{\mathcal{K}}$ and spreading $a_{\mathcal{K}}$ of the Gaussian potential, the number of layers $m$, the angular momentum $\ell$ and the number of sites in the radial coordinate $N$.
