...
\end{split}
\end{equation}
and their corresponding small-momentum regimes are described by
\begin{equation}
\begin{split}
\Sigma^{1}\!(\mathbf{k })
\! &\approx \!
...
\caption{Hartree-Fock $\huge{\alpha}$ self-energies of the Dirac fermions for monolayer and bilayer graphene with the Gaussian potential ($V_{0}=1$ and $a=1$). }
